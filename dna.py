...
class Dna:
    def __init__(self, parents, archTypes, dnaLength):
        self.mutationRate = 0.05                       #chance for a gane to mutate
        ...
        if not parents:
            ...
            print("parentDifference %f , %f for  %s and %s at threshold of %f" % (parentDifference1, parentDifference2, parents[0].name.toString(), parents[1].name.toString(),  self.archTypeThreshold ))
